...
def plot_metrics(model, model_type, dataset):
    ...
    fig.suptitle(
        "Losses and hit-rates during training of {} on {}".format(model_type, dataset),
        fontsize=14,
    )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Train model of a given model type on a given dataset with the best parameters saved by validation.py"
    )
    parser.add_argument(
        "model_type",
        metavar="model_type",
